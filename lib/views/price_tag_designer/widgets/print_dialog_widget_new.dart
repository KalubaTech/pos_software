...
class _PrintDialogWidgetState extends State<PrintDialogWidget> {
  ...
  void initState() {
    super.initState();
    // Load available printers and set connected printer as selected
    _loadPrinters();
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'No printers found. Please configure printers in System Settings.',
                                  style: TextStyle(
                  ...
                  return DropdownButtonFormField<BluetoothInfo>(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Type: Bluetooth Thermal • MAC: ${selectedPrinter!.macAdress}',
                            style: TextStyle(
                              fontSize: 11,
  ...
  void _printTags() {
    ...
    // TODO: Implement actual printing with selected Bluetooth printer
    // This would generate the price tags based on the template
    // and send them to the selected Bluetooth thermal printer
